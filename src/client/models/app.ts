...
export interface IProject { // TO DO: change name - there are two IProject interfaces another in ./project.ts
    readonly id: number,
...
export interface IUserRecord
    extends TypedRecord<IUserRecord>, IUser { };
...
export const userRecordFactory
    = makeTypedFactory<IUser, IUserRecord>(defaultUserRecord);