...
export class RegisterPanel extends React.Component<RegisterPanelProps, RegisterPanelState> {
            ...
            const afterAccountEmail = axios.head(urlBase + '/account/' + email),
                emailUniqueByResponseStatus = (responseStatus: number): boolean | null => {
                    ...
                    switch (responseStatus) {
                        case 200: emailUnique = false; break;
                        case 404: emailUnique = true; break;
                    }
    ...
    private onEmailChange(e: React.ChangeEvent<HTMLInputElement>) { // TO DO: check if e type is correct
    ...
    private onFirstnameChange(e: React.ChangeEvent<HTMLInputElement>) { // TO DO: check if e type is correct
    ...
    private onLastnameChange(e: React.ChangeEvent<HTMLInputElement>) { // TO DO: check if e type is correct
    ...
    private onPasswordChange(e: React.ChangeEvent<HTMLInputElement>) { // TO DO: check if e type is correct
    ...
    private onPasswordRepeatChange(e: React.ChangeEvent<HTMLInputElement>) { // TO DO: check if e type is correct
    ...
    private passwordRepeatValid(passwordRepeat: string, password: string): boolean {
            ...
            <div>
                ...
                : <form>
                    ...
                    <FormGroup controlId='RegisterPanelFirstnameIntpu' validationState={this.getValidationState(firstnameValid)} >
                        ...
                        <FormControl.Feedback />
                        <HelpBlock>{this.messageOnNotValid(firstnameValid, 'Firsname field cannot be blank.')}</HelpBlock>
                    </FormGroup>
                    <FormGroup controlId='RegisterPanelLastnameInput' validationState={this.getValidationState(lastnameValid)} >
                        <FormControl type='text' placeholder='Lastname' value={lastname} onChange={this.onLastnameChange} />
                        <FormControl.Feedback />
                        <HelpBlock>{this.messageOnNotValid(lastnameValid, 'Lastname field cannot be blank.')}</HelpBlock>
                    </FormGroup>
                    <FormGroup controlId='RegisterPanelPasswordInput' validationState={this.getValidationState(passwordValid)} >
                        <FormControl type='password' placeholder='Password' value={password} onChange={this.onPasswordChange} />
                        <FormControl.Feedback />
                        <HelpBlock>{this.messageOnNotValid(passwordValid, 'Firsname field cannot be blank.')}</HelpBlock>
                    </FormGroup>
                    <FormGroup controlId='RegisterPanelRepeatPasswordInput' validationState={this.getValidationState(passwordRepeatValid)} >
                        <FormControl type='password' placeholder='Repeat password' value={passwordRepeat} onChange={this.onPasswordRepeatChange} />
                        <FormControl.Feedback />
                ...
                <Modal.Dialog>
                    ...
                    <Modal.Body>
                        ...
                        <div className='text-center'>
                            <Button bsStyle='link' onClick={this.switchToLogin}>Login</Button>
                        </div>
                    </Modal.Body>
                </Modal.Dialog>
            </div>
