...
export class ColorPicker extends React.Component<ColorPickerProps, ColorPickerState> {
    constructor(props: ColorPickerProps) {
        ...
        this.onSketchPickerChangeComplete = this.onSketchPickerChangeComplete.bind(this);
    ...
    render() {
        ...
        return (
            ...
            <Button onClick={this.onModalShow} style={{ backgroundColor: color }}>
                <span className="glyphicon glyphicon-pencil" style={{ color: this.getGlyphiconColor() }}></span>
            </Button>
            <Modal
                show={show}
                enforceFocus={false}
