...
export const state = projectRecordFactory({
  ...
  alvisProject: alvisProjectRecordFactory({
    ...
    agents: Map([
      ...
      ['5', getBasicAgentRecordForTests('A2', '0', null, '5', Set(['16']))],
      ['6', getBasicAgentRecordForTests('A3', '1', null, '6', Set(['17']))],
      [
        '7',
        getBasicAgentRecordForTests('A4', '1', '3', '7', Set(['18', '19'])),
      ],
      ['8', getBasicAgentRecordForTests('A5', '1', '2', '8', Set(['20']))],
      ['9', getBasicAgentRecordForTests('A6', '2', null, '9', Set(['21']))],
      ['10', getBasicAgentRecordForTests('A7', '2', null, '10', Set(['22']))],
      [
        '11',
        getBasicAgentRecordForTests('A8', '3', null, '11', Set(['23', '24'])),
      ],
      ['12', getBasicAgentRecordForTests('A9', '3', null, '12', Set(['25']))],
      ['13', getBasicAgentRecordForTests('A10', '3', null, '13', Set(['26']))],
    ]),
    ports: Map([
